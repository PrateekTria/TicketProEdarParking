package com.ticketpro.parking.syncbackup.syncactivity;
...
import com.ticketpro.parking.syncbackup.syncmodel.CSV_Params;
import com.ticketpro.parking.syncbackup.syncmodel.CSVinfo_Json_rpc;
import com.ticketpro.parking.syncbackup.syncmodel.Csvinfo;
import com.ticketpro.parking.syncbackup.syncmodel.Dbinfo;
import com.ticketpro.parking.syncbackup.syncmodel.Dbinfo_Json_rpc;
import com.ticketpro.parking.syncbackup.syncmodel.Dbinfo_Param;
import com.ticketpro.parking.syncbackup.syncmodel.Debuginfo;
import com.ticketpro.parking.syncbackup.syncmodel.Params;
...
public class NewSyncBackup extends BaseActivityImpl {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                upload_dbbackup_btn.setVisibility(View.GONE);
    ...
    public void callBackupCSV() throws IOException {
    ...
    public void uploadCSVBackup(ArrayList<String> Csvname,ArrayList<String> CSVdata ) throws IOException {
    ...
    public void uploadDatabaseBackup(String dbName,String dbData) throws IOException {
        upload_dbbackup_progress.setVisibility(View.VISIBLE);
    ...
    public void uploadDebugLog(String debugDData) throws IOException {
