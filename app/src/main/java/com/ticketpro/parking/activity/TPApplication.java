...
public class TPApplication extends MultiDexApplication {
    ...
    public int act_assignmentid=0;
    public String act_assignmentlocationpos="";
    public int  act_dutylocationid=0;
    public String act_assignmentname="";
    public String act_dutylocationname="";
    public String DutyReportId="";

    public String dutyInTime="";
    ...
    public boolean enableSpPlus = true;
    ...
    private String darStartTimeTask;
    private String darStartTimeLocation;
    private String darStartTimeAssignment;
    private String assignReportId="";
    private  String AssignmentLocationReportid;
    private String AssLocRecId="";
    private String darTaskReoprtId="";
    private String darParkingdutyreportId="";
    private String shiftStartTime="";
    private String shiftEndTime="";
    private String shiftType="";
    private String vehicleString="";
    private String vehicleNumberString="";
    private String Overtime_Note="";
    ...
    public String getVehicleNumberString() {
        return vehicleNumberString;
    }

    public void setVehicleNumberString(String vehicleNumberString) {
        this.vehicleNumberString = vehicleNumberString;
    }

    Date datein;
    private ArrayList<DarDisinfectingElements> itemList;

    public ArrayList<DarDisinfectingElements> getItemList() {
        return itemList;
    }

    public void setItemList(ArrayList<DarDisinfectingElements> itemList) {
    ...
    private ArrayList<DarVdrElements> itemVdr;

    public ArrayList<DarVdrElements> getItemVdr() {
        return itemVdr;
    }

    public void setItemVdr(ArrayList<DarVdrElements> itemVdr) {
        this.itemVdr = itemVdr;
    }

    public boolean isEnableSpPlus() {
        return enableSpPlus;
    }

    public void setEnableSpPlus(boolean enableSpPlus) {
        this.enableSpPlus = enableSpPlus;
    }
    ...
    public String getOvertime_Note() {
        return Overtime_Note;
    }

    public void setOvertime_Note(String overtime_Note) {
    ...
    public String getAct_assignmentname() {
        return act_assignmentname;
    }

    public int getDardutyId() {
        return DardutyId;
    }

    public void setDardutyId(int dardutyId) {
        DardutyId = dardutyId;
    }

    public void setAct_assignmentid(int act_assignmentid) {
        this.act_assignmentid = act_assignmentid;
    }
    ...
    public void setAct_assignmentlocationpos(String act_assignmentlocationpos) {
        this.act_assignmentlocationpos = act_assignmentlocationpos;
    }
    ...
    public void setAct_dutylocationid(int act_dutylocationid) {
        this.act_dutylocationid = act_dutylocationid;
    }

    public void setAct_dutylocationname(String act_dutylocationname) {
        this.act_dutylocationname = act_dutylocationname;
    }

    public void setAct_assignmentname(String act_assignmentname) {
        this.act_assignmentname = act_assignmentname;
    }

    public int getAct_assignmentid() {
        return act_assignmentid;
    }

    public int getAct_dutylocationid() {
        return act_dutylocationid;
    }

    public String getAct_assignmentlocationpos() {
        return act_assignmentlocationpos;
    }

    public String getAct_dutylocationname() {
        return act_dutylocationname;
    }

    public String getDarParkingdutyreportId() {
        return darParkingdutyreportId;
    }

    public void setDarParkingdutyreportId(String darParkingdutyreportId) {
        this.darParkingdutyreportId = darParkingdutyreportId;
    }
    ...
    public String getDarTaskReoprtId() {
        return darTaskReoprtId;
    }

    public String getAssLocRecId() {
        return AssLocRecId;
    }

    public String getAssignmentLocationReportid() {
        return AssignmentLocationReportid;
    }

    public String getAssignReportId() {
        return assignReportId;
    }

    public String getDarStartTimeAssignment() {
        return darStartTimeAssignment;
    }

    public String getDarStartTimeLocation() {
        return darStartTimeLocation;
    }

    public String getDarStartTimeTask() {
        return darStartTimeTask;
    }

    public String getEquipmentChild() {
        return equipmentChild;
    }
    ...
    public void setDarTaskReoprtId(String darTaskReoprtId) {
        this.darTaskReoprtId = darTaskReoprtId;
    }

    public void setAssLocRecId(String assLocRecId) {
        AssLocRecId = assLocRecId;
    }

    public void setAssignmentLocationReportid(String assignmentLocationReportid) {
        AssignmentLocationReportid = assignmentLocationReportid;
    }

    public void setAssignReportId(String assignReportId) {
    ...
    public void setDarStartTimeAssignment(String darStartTimeAssignment) {
        this.darStartTimeAssignment = darStartTimeAssignment;
    }

    public void setDarStartTimeLocation(String darStartTimeLocation) {
        this.darStartTimeLocation = darStartTimeLocation;
    }

    public void setDarStartTimeTask(String darStartTimeTask) {
        this.darStartTimeTask = darStartTimeTask;
    }
    ...
    public void setEquipmentChild(String equipmentChild) {
        this.equipmentChild = equipmentChild;
    }
