...
public class DutyReport implements Serializable {
    ...
    public static ArrayList<DutyReport> getDutyRecord(String formatDate) throws TPException {
        ArrayList<DutyReport> list = new ArrayList<DutyReport>();
        list = (ArrayList<DutyReport>) ParkingDatabase.getInstance(TPApplication.getInstance()).dutyReportsDao().getAllDutyReportsForCurrentDate(formatDate);
        return list;
    }
