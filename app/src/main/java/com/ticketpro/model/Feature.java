...
public class Feature {
    ...
    public static  final String DAR_REPORT_SYNC="DAR_REPORT_SYNC";
    ...
    //vendor-name=TurboData,x-api-key=c8eb98f8-dfde-451a-88c3-ce98eba0aa39
    ...
    public static boolean isHiddenField(String fieldName) {
        if (Feature.isFeatureAllowed(Feature.IS_HIDDEN)) {
            ...
            if (fields.contains(",")){
                ...
                return s != null && s.toLowerCase().equalsIgnoreCase(fieldName);
