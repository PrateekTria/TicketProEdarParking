...
public final class TrainingModelDao_Impl implements TrainingModelDao {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<TrainingModel> __insertionAdapterOfTrainingModel;

  private final SharedSQLiteStatement __preparedStmtOfRemoveAll;

  private final SharedSQLiteStatement __preparedStmtOfRemoveById;

  public TrainingModelDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfTrainingModel = new EntityInsertionAdapter<TrainingModel>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `training` (`id`,`userId`,`assignment_id`,`equipment_id`,`sub_equipment_id`,`vdr`,`disinfecting`,`mileage`,`mileage_id`,`dar_task_report_id`,`vehicle`,`nonInforcement_dd_elementId`,`datetime`,`name_of_trainer_dd_elementId`,`district_dd_elementId`,`deviceid`,`appId`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, TrainingModel value) {
    ...
    this.__preparedStmtOfRemoveAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "DELETE from training";
        return _query;
      }
    };
  ...
  @Override
  public void insertTrainingModel(final TrainingModel... data) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfTrainingModel.insert(data);
  ...
  @Override
  public Completable insertTrainingModel(final TrainingModel data) {
  ...
  @Override
  public void insertTrainingModelList(final List<TrainingModel> taskForm22500ModelList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfTrainingModel.insert(taskForm22500ModelList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public List<TrainingModel> getTrainingModel() {
    ...
    try {
      ...
      final List<TrainingModel> _result = new ArrayList<TrainingModel>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final TrainingModel _item;
        _item = new TrainingModel();
        final long _tmpId;
