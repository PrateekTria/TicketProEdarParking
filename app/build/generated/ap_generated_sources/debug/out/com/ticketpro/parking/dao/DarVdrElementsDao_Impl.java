...
public final class DarVdrElementsDao_Impl implements DarVdrElementsDao {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<DarVdrElements> __insertionAdapterOfDarVdrElements;

  private final SharedSQLiteStatement __preparedStmtOfRemoveAll;

  private final SharedSQLiteStatement __preparedStmtOfRemoveById;

  public DarVdrElementsDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfDarVdrElements = new EntityInsertionAdapter<DarVdrElements>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `dar_vdr` (`id`,`veh_task_id`,`name`,`userid`,`custid`,`is_active`,`order_number`,`created_by`,`updated_by`,`isSelected`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, DarVdrElements value) {
    ...
    this.__preparedStmtOfRemoveAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "DELETE from dar_vdr";
        return _query;
      }
    };
    this.__preparedStmtOfRemoveById = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "DELETE from dar_vdr where id=?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insertDarVdrElements(final DarVdrElements... data) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfDarVdrElements.insert(data);
  ...
  @Override
  public void insertDarVdrElementsList(final List<DarVdrElements> darVehicleLists) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfDarVdrElements.insert(darVehicleLists);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public Maybe<List<DarVdrElements>> getDarVdrElementsList(final int userid) {
    final String _sql = "select * from dar_vdr where veh_task_id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, userid);
    return Maybe.fromCallable(new Callable<List<DarVdrElements>>() {
      @Override
      public List<DarVdrElements> call() throws Exception {
        ...
        try {
          ...
          final List<DarVdrElements> _result = new ArrayList<DarVdrElements>(_cursor.getCount());
          while(_cursor.moveToNext()) {
            final DarVdrElements _item;
            _item = new DarVdrElements();
            final int _tmpId;
  ...
  @Override
  public Maybe<List<DarVdrElements>> getVdrList() {
    final String _sql = "select * from dar_vdr order by order_number, name";
